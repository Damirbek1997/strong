...
public interface UserController {
    ...
    void changeCredentials(@RequestParam String username, @RequestParam String oldPassword, @RequestParam String newPassword);
    ...
    void updateStatus(@RequestParam String username, @RequestParam Boolean active);
}
